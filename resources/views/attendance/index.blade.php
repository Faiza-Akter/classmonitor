    ...
    <div class="min-h-[calc(100vh-88px)] text-white" style="
                ...
                <section class="lg:col-span-2 cm-card cm-card-h">
                    ...
                    <div class="mt-5 cm-card-inner flex-1 flex flex-col overflow-hidden">
                        @if($activeSession)
                                ...
                                <div class="w-full rounded-2xl border p-6"
                                    ...
                                    <div class="flex flex-col sm:flex-row items-center gap-6">
                                        ...
                                        <div class="min-w-0 text-center sm:text-left">
                                            ...
                                            <div
                                                class="mt-4 flex flex-wrap items-center justify-center sm:justify-start gap-2 text-xs font-semibold text-slate-700">
                            ...
                            {{-- ✅ Attendance list with scrollbar (like right panel) --}}
                            <div class="mt-4 flex-1 min-h-0 overflow-auto pr-1 cm-scroll" id="latestList">
                                {{-- JS fills this --}}
                            </div>
        ...
        <style>
            ...
            .cm-card {
                ...
                /* ✅ Fix: ensure text inside cards is dark (not inherited white) */
                color: rgb(15 23 42);
            }
